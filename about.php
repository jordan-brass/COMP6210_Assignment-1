...
<body>
    ...
    <div class = "row">
        <div class = "col s8 card z-depth-4">
            <div class="card-tabs">
                <ul class="tabs tabs-fixed-width">
                    <li class="tab"><a href="#tab1">What is NZRPG?</a></li>
                    <li class="tab"><a href="#tab2">What is D&amp;D?</a></li>
                    <li class="tab"><a href="#tab3">What is Adventurer's League?</a></li>
                </ul>
        ...
        <div class = "col s4">
            <div class = "card">
                ...
                <br>
                <h4 class = "white-remove" style = "color: white; align: center; margin-bottom: 0rem;"><b>Who is in NZRPG?</b></h4>
                </div>
